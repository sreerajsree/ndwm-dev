...
const MobileNav = () => {
  ...
  return (
    <div className="sm:hidden">
      <button
        type="button"
        className="ml-1 mr-1 h-10 w-10 rounded py-1"
      ...
      >
        ...
        <nav className="fixed mt-20 h-full text-5xl">
          <div key="Home" className="px-12 py-4">
            <Link
              href="/"
              onClick={() => setNavShow(!navShow)}
              className={classNames(
                'horizontal-underline uppercase font-bold tracking-widest text-gray-900 backdrop:text-2xl dark:text-gray-100',
